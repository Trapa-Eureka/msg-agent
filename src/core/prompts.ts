...
export function summaryPrompt(doc: ExtractedDoc, to: string): TranslatePrompt {
  const system = [
    ...
    "1. **Title** — the document's title or a one-line description of what it is.",
    "2. **Key points** — 3 to 7 bullets covering the main clauses, decisions, or findings.",
    "3. **Figures** — every important number: amounts, dates, deadlines, quantities, percentages. Preserve them exactly as written.",
    "4. **Action items** — what the reader is asked to do, decide, or reply to, with deadlines. Write the section headings in the target language.",
    "Rules:",
