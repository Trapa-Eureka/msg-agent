...
- [x] npm 계정 2FA 확인(2026-09-06)
- [x] 저장소 공개 전환(2026-09-06, PUBLIC 확인)
- [x] `npm publish` → `msg-agent@0.1.0` 게시, 태그 `v0.1.0` 푸시, `npx msg-agent@0.1.0 --version` = 0.1.0 (2026-09-06)
- [x] 공개 후 README 상태 줄에 npm 링크·버전 기재(2026-09-06)

**v0.1.0 릴리스 완료(2026-09-06).** 다음은 v0.2 대기열.
